...
num_neighbors = NumNeighbors({
    ('constructor_results', 'f2p_constructorId', 'constructors'): [0, 0, 64],
    ('constructor_results', 'f2p_raceId', 'races'): [0, 0, 64],
    ...
    ('drivers', 'rev_f2p_driverId', 'qualifying'): [0, 64, 0],
    ('drivers', 'rev_f2p_driverId', 'results'): [0, 64, 0],
    ('drivers', 'rev_f2p_driverId', 'standings'): [0, 64, 0],

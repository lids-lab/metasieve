...
num_neighbors = NumNeighbors({
    ...
    ('comments', 'f2p_UserId', 'users'): [0, 0, 64],
    ('postHistory', 'f2p_PostId', 'posts'): [0, 64, 64],
    ('postHistory', 'f2p_UserId', 'users'): [64, 0, 64],
    ('postLinks', 'f2p_PostId', 'posts'): [0, 0, 64],
    ('posts', 'f2p_OwnerUserId', 'users'): [64, 0, 64],
    ('posts', 'f2p_ParentId', 'posts'): [0, 64, 0],
    ('posts', 'rev_f2p_ParentId', 'posts'): [0, 0, 64],
    ('posts', 'rev_f2p_PostId', 'postHistory'): [0, 64, 64],
    ('users', 'rev_f2p_OwnerUserId', 'posts'): [0, 64, 64],
    ('users', 'rev_f2p_UserId', 'badges'): [0, 64, 0],
    ('users', 'rev_f2p_UserId', 'postHistory'): [0, 64, 64],
    ('votes', 'f2p_PostId', 'posts'): [0, 0, 64],
    ('votes', 'f2p_UserId', 'users'): [0, 0, 64],
}, default=[0] * 3)
